...
router.post('/delete', auth.auth('admin'), residentApplicationCtrl.postResidentApplicationDelete); // 刪除申請
router.get('/info', residentApplicationCtrl.getResidentApplicationInfo);
router.post('/paid', auth.auth('admin'), residentApplicationCtrl.postPayTheFee);
